...
@section('content')
    ...
    {!! Form::model($expense, ['method' => 'PUT', 'route' => ['admin.expenses.update', $expense->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('project_id', trans('global.expenses.fields.project').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('expense_type_id', trans('global.expenses.fields.expense-type').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('meeting_id', trans('global.expenses.fields.meeting').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('contingency_id', trans('global.expenses.fields.contingency').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('due_date', trans('global.expenses.fields.due-date').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('invoice_subtotal', trans('global.expenses.fields.invoice-subtotal').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('invoice_taxes', trans('global.expenses.fields.invoice-taxes').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('invoice_total', trans('global.expenses.fields.invoice-total').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('budget_subtotal', trans('global.expenses.fields.budget-subtotal').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('budget_taxes', trans('global.expenses.fields.budget-taxes').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('budget_total', trans('global.expenses.fields.budget-total').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('provider_id', trans('global.expenses.fields.provider').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('service_type_id', trans('global.expenses.fields.service-type').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('pm_id', trans('global.expenses.fields.pm').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('files', trans('global.expenses.fields.files').'', ['class' => 'control-label']) !!}
                    {!! Form::file('files[]', [
                        'multiple',
                    ...
                    <div class="photo-block">
                        ...
                        <div class="files-list">
                            @foreach($expense->getMedia('files') as $media)
                                <p class="form-group">
